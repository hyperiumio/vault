...
class KeyCryptorTestCase: XCTestCase {
    ...
    func testWrapPassedArguments() throws {
        ...
        _ = try KeyEncrypt(keyEncryptionKey: kek, key: key, keyWrap: keyWrapMock.wrap)
    ...
    func testWrapSuccess() throws {
        ...
        let result = try KeyEncrypt(keyEncryptionKey: kek, key: key, keyWrap: keyWrapMock.wrap)
    ...
    func testWrapFailure() {
        ...
        XCTAssertThrowsError(try KeyEncrypt(keyEncryptionKey: kek, key: key, keyWrap: keyWrapMock.wrap)) { error in
    ...
    func testUnwrapPassedArguments() throws {
        ...
        _ = try KeyDecrypt(keyEncryptionKey: kek, wrappedKey: wrappedKey, keyUnwrap: keyUnwrapMock.unwrap)
    ...
    func testUnwrapSuccess() throws {
        ...
        let result = try KeyDecrypt(keyEncryptionKey: kek, wrappedKey: wrappedKey, keyUnwrap: keyUnwrapMock.unwrap)
    ...
    func testUnwrapFailure() {
        ...
        XCTAssertThrowsError(try KeyDecrypt(keyEncryptionKey: kek, wrappedKey: wrappedKey, keyUnwrap: keyUnwrapMock.unwrap)) { error in
